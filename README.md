...
move between annotations, and press Enter to read its comment. Enter closes the
comment popup and stays in annotation mode; Escape or `q` closes the popup and
